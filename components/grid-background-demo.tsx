...
export default function GridBackgroundDemo() {
  return (
    <div className="relative flex h-[50rem] w-full items-center justify-center bg-zinc-950">
      <div
        className={cn(
          "absolute inset-0",
      ...
      <p className="relative z-20 bg-gradient-to-b from-zinc-100 to-zinc-500 bg-clip-text py-8 text-4xl font-bold text-transparent sm:text-7xl font-display">
