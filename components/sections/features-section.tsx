      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-500 max-w-xl mx-auto text-balance">
            Advanced features built to streamline your gare d'appalto bidding pipeline.
          </p>
        </motion.div>
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">Tender Control Tower</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">
                  Track active public & private bids, deadlines, and success ratios in one place.
                </p>
                <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4 overflow-hidden">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      >
                        ...
                        <span className="text-xs text-zinc-500">Tenders</span>
                      </motion.div>
                      <motion.div
                        className="flex items-center gap-1.5"
                        initial={{ opacity: 0 }}
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    {[
                      { label: "Active Bids", value: "12", change: "+4" },
                      { label: "Avg. Win Rate", value: "78%", change: "+12%" },
                      { label: "Avg. Margin", value: "11.2%", change: "+1.5%" },
                    ].map((metric, i) => (
                      <motion.div
                        key={metric.label}
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">AI Extraction Engine</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">Instantly extract line items from complex PDF/Excel computi metrici.</p>
                <div className="mt-auto">
                  <div className="flex items-baseline gap-2 mb-3">
                    ...
                    <span className="text-zinc-500 text-sm">extraction accuracy</span>
                  </div>
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">Margin Simulator</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">Run instant 'what-if' margin models to calculate project pricing.</p>
                <div className="flex justify-center gap-2 mt-auto">
                  {["10%", "15%", "20%"].map((key, i) => (
                    <motion.div
                      key={key}
                      className="flex items-center justify-center w-14 h-10 rounded-xl bg-zinc-800/80 border border-zinc-700/50 shadow-lg"
                      initial={{ y: 0 }}
                      animate={{ y: [0, -4, 0] }}
                      transition={{
                        duration: 1.5,
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">Regional Cost Catalogs</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">Verify prices against official regional lists (Prezzari Regionali).</p>
                <div className="grid grid-cols-2 gap-2 mt-auto">
                  {["Lombardia", "Lazio", "Veneto", "Piemonte"].map((reg, i) => (
                    <motion.div
                      key={reg}
                      initial={{ opacity: 0, y: 10 }}
                      whileInView={{ opacity: 1, y: 0 }}
                      ...
                      className="py-1.5 rounded-lg border border-zinc-800 bg-zinc-800/40 flex items-center justify-center cursor-pointer text-xs font-mono text-zinc-400 hover:text-zinc-200 hover:border-zinc-700"
                    >
                      {reg}
                    </motion.div>
                  ))}
                ...
                >
                  View price lists database <ArrowRight className="w-4 h-4" />
                </motion.button>
              </CardContent>
            </Card>
          </motion.div>
